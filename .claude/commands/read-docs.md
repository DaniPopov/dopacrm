Read all project documentation to build full context for this session.
...
- Current project status (what exists, what's next)
- Any open questions from the docs that are still unresolved
- Key conventions to follow in this session
